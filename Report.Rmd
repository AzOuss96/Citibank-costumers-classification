...
# Introduction 
In this report, we compare several classification algorithms on a citibank' clients dataset. The aim of this project is to make a decent classification of Citibank's users ethnicity based on their bank account information. In the first section we perform some exploratory data analysis to understand the data. In the second part, we apply single learners algorithms. Finally, the third part is dedicated to using Ensemble methods to perform classification. We chose confusion matrices as a metric for performance comparaison.
